...
MOCK_BUSD_USD_PRICE = "1"
MOCK_XRP_USD_PRICE = "0.5"
MOCK_XLM_USD_PRICE = "0.1"
MOCK_JPY_USD_PRICE = "0.007"
...
class MockPairConverter:
    ...
    def __init__(
        ...
        busd_price: str = MOCK_BUSD_USD_PRICE,
        xrp_price: str = MOCK_XRP_USD_PRICE,
        xlm_price: str = MOCK_XLM_USD_PRICE,
        jpy_price: str = MOCK_JPY_USD_PRICE,
    ):
